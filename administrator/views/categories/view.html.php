 ...
 * @since  1.6
 */
class EventsViewCategories extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		EventsHelpersEvents::addSubmenu('categories');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_EVENTS_TITLE_CATEGORIES'), 'folder');
		...
		JHtmlSidebar::setAction('index.php?option=com_events&view=categories');
	...
	{
		return array(
			'a.`title`' => JText::_('COM_EVENTS_CATEGORIES_TITLE'),
			'a.`color`' => JText::_('COM_EVENTS_CATEGORIES_COLOR'),
