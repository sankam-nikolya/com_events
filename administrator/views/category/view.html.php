 ...
 * @since  1.6
 */
class EventsViewCategory extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_EVENTS_TITLE_CATEGORY'), 'folder');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_events.category', $this->item->id);
		}
